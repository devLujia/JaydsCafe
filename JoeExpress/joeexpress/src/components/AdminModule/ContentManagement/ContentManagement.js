  ...
  return (
    <div>
        <nav class="z-20 bg-white border-gray-200 dark:bg-gray-900 top-0 sticky flex justify-end shadow-md">
            ...
            <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="w-10 h-10 rounded-full cursor-pointer" src={picture} alt="User dropdown"/>
        ...
        <div class="p-4 sm:ml-72 mb-5">
            <div class="relative overflow-x-visible shadow-md sm:rounded-lg">
                <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 p-4 bg-white dark:bg-gray-900 rounded-lg">
                    <div class="h-fit items-center justify-center flex bg-white px-4 py-1 shadow-md rounded-xl border-2 ms-1"> {/* <!-- Date --> */}
                        <h1> June 14, 2024 - July-14,2024 </h1>
                    </div>
                    ...
                    {/* <!-- Dropdown menu --> */}
                    <div id="shortByDropDown" data-dropdown-content class="right-3 top-12 absolute z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-32 dark:bg-gray-700">
        ...
        <div class="p-4 sm:ml-72 mb-5">
            <div class="shadow-md sm:rounded-lg  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-white">
                <div class="flex justify-center items-center border-r-2 border-slate-200  h-[80%] my-auto">
                    <div class="flex items-center justify-center">
                        <div class="flex flex-col py-6">
                            <p class="font-bold text-2xl"> ₱4,354</p>
                            <p class="text-gray-500">Unique Visitors</p>
                        </div>
                        <p class="inline-flex text-green-500 ">0.43% <img src={arrowUP} alt="Arrow_Up" class="w-4 h-4 my-auto pl-1"/></p>
                    </div>
                </div>
                <div class="flex justify-center items-center border-r-2 border-slate-200  h-[80%] my-auto">
                    <div class="flex items-center justify-center">
                        <div class="flex flex-col py-6">
                            <p class="font-bold text-2xl">
                                <span class="num" data-val="55.9">
                                    55.9
                                </span>K</p>
                            <p class="text-gray-500">Total Page views</p>
                        </div>
                        <p class="inline-flex text-green-500 ">25% <img src={arrowUP} alt="Arrow_Up" class="w-4 h-4 my-auto pl-1"/></p>
                    </div>
                </div>
                <div class="flex justify-center items-center border-r-2 border-slate-200  h-[80%] my-auto">
                    <div class="flex items-center justify-center">
                ...
                <div class="flex justify-center items-center h-[80%] my-auto">
                    <div class="flex items-center justify-center">
                        <div class="flex flex-col py-6">
                            <p class="font-bold text-2xl">
                                ...
                                <span class="num" data-val="57">
                                    00
                                </span>s
                            </p>
                            <p class="text-gray-500">Visits Duration</p>
                        </div>
                        <p class="inline-flex text-red-500 ">0.43% <img src={arrowDOWN} alt="Arrow_Up" class="w-4 h-4 my-auto pl-1"/></p>                </div>
                </div>
            </div>
        </div>  
