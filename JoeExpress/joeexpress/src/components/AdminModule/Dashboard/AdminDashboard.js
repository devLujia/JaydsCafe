         ...
         <a href="#" class="flex items-center ps-2.5 mb-5">
            ...
            <ul class="space-y-2 font-medium ">
               ...
               {tier3.includes(role) ? <li> {/* <!-- Dashboard --> */}
                  <a href="#" class={`flex items-center p-2 rounded-lg bg-greenColor group text-white dark:text-write`}>
            ...
            {tier3.includes(role) || tier2.includes(role) || tier1.includes(role) ? <li> {/* <!-- Inbox --> */}
               <a href="/Message" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-greenColor group dark:text-white hover:text-white">
         ...
         <div class="p-4 ml-8">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg col-span-2 mb-6 ">
                  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                     <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <div class="flex justify-between sticky top-0 bg-white p-3 dark:bg-[#282828] dark:text-white">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
                              <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:dark:bg-[#3f3f3f] dark:text-white">
                              ...
                              {orders.slice(0, 2).map(order => (
                                 <React.Fragment key={order.order_id}>
                                    <tr className="bg-white border-b hover:bg-gray-50 dark:bg-[#575757] dark:hover:bg-[#8b8b8b] dark:text-gray-300 dark:hover:text-white">
                                       ...
                                       <td className="px-4 py-4 text-center text-greenColor dark:text-green-500">
                                       ₱ {order.totalPrice}.00
                                       </td>
            ...
            <div class="grid grid-cols-1 md:grid-cols-[65%_34%] gap-4 mb-6">
               ...
               <div class="relative overflow-x-auto shadow-xl sm:rounded-lg col-span-1">
                     <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 p-4 bg-white dark:bg-[#282828] dark:text-white">
                     ...
                     <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:dark:bg-[#3f3f3f] dark:text-white">
                        ...
                        <tbody>
                           ...
                           <tr key={food.id} class="bg-white border-b hover:bg-gray-50 dark:bg-[#575757] dark:hover:bg-[#8b8b8b] dark:text-white">
               ...
               {/* Content */}
               <div class="bg-white rounded-xl p-4 h-[400px] overflow-hidden dark:bg-[#282828] dark:text-gray-300">
                  <div class="flex justify-between sticky top-0 bg-white mb-5 z-10 dark:bg-[#282828]">
                  ...
                  <div className='flex flex-col justify-center space-y-5 items-center overflow-y-auto max-h-full pt-40 pb-10 '>
                     {cmsContent.map(cms =>(
                        <div key={cms.id} className='relative border-2 border-gray-500 rounded-xl w-3/5 text-center px-2 shadow-xl dark:dark:bg-[#3f3f3f] dark:text-gray-300'>
