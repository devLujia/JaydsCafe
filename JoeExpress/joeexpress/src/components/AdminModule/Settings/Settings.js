...
export default function Settings() {
  return (
    <div>
        ...
        {/* Aside */}
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-72 h-screen pt-5 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-[#282828]" aria-label="Sidebar">
            ...
            <a href="#" class="flex items-center ps-2.5 mb-5">
               ...
               <ul class="space-y-2 font-medium">
                  <li> {/* <!-- Dashboard --> */}
                     <a href="/dashboard" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-greenColor group hover:text-white dark:text-white">
                     <svg class="w-5 h-5 transition duration-75 text-gray-600  group-hover:text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                  ...
                  <li> {/* <!-- Product Management --> */}
                     <Link to="/ProductManagement">
                        <a href="/public/Html_Admin/productManagement.html" class="flex items-center p-2 text-gray-600 rounded-lg  hover:bg-greenColor group hover:text-white dark:text-white">
