    ...
    <div class="bg-background">
      ...
      <div class="max-w-md mx-auto p-4 mt-2 mb-4 bg-white rounded-xl shadow-md md:max-w-lg md:p-6 md:pt-4 md:mb-6 lg:max-w-xl lg:p-8 lg:pt-6 lg:mb-8">
          ...
          <div class="mb-6 flex items-center"> {/* <!-- Checkbox Input-->*/}
              ...
              <span class="text-blue-500 text-lg cursor-pointer font-bold pl-2" data-modal-target="default-modal" data-modal-toggle="default-modal" >Terms & conditions</span>
          </div>
              ...
              <div class="relative p-4 w-full max-w-2xl max-h-full">
                  ...
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                          <button id="accept-button" data-modal-hide="default-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I accept</button>
