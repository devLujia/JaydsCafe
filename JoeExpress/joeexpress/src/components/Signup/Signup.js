...
import userAccImage from '../image/UserAcc.png';
...
function Signup() {
    ...
    return (
        ...
        <section className="bg-background">
            ...
            <nav class="sticky top-0 bg-white z-20 flex justify-between items-center px-4">
            <div className="font-extrabold text-3xl flex items-center">
          
                  <a href="#" className="flex items-center"><div className="w-16 h-16 overflow-hidden flex justify-center items-center border border-gray-300 rounded-md">
                  <img src={cmsSmallLogo} alt="logo" className="object-cover w-full h-full logo" />
                    </div>{cmsName}</a>
                </div>

                    <span class="menu">
                        <ul class="nav_links md:hidden lg:flex lg:flex-row lg:justify-between">
            ...
            <button class="burger lg:hidden mr-3" id="burger-btn" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" type="button"><img src={menuImage} alt=""/></button>

                {/* <!-- Dropdown menu --> */}
                <div id="dropdownHover" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="burger-btn">
                      <li>
                        <a href="/public/index.html" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Home</a>
                      </li>
                      <li>
                ...
                <Link to={'/'}>
                    <button class="btn mr-3 w-48 h-14 bg-footer text-gray-100 text-lg font-medium tracking-widest">Order Now!</button>
                </Link>
                        <div class="flex space-x-2 mr-2">
                            <a href="#"><img src={userAccImage} alt="user" class="mr-3"/></a>
                            <a href="#"><img src={bagImage} alt="bag"/></a>
                        </div>
                    </div>
                </nav>
                    ...
                    <div className="max-w-md mx-auto p-4 mt-2 mb-4 bg-white rounded-xl shadow-md md:max-w-lg md:p-6 md:pt-4 md:mb-6 lg:max-w-xl lg:p-8 lg:pt-6 lg:mb-8">
                        <h1 className="text-3xl font-extrabold mb-6 text-black tracking-wider">
                        Register
                        </h1>
                    ...
                    {/* <div class="mb-4"> 
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 mb-2 text-gray-700 leading-10 focus:outline-none focus:shadow-outline" id="Phone" type="tel" placeholder="0912-345-6789" required/>
                    </div> */}
                        ...
                        <div class="mb-4">
                                ...
                                <img src={hiddenImage} alt="Eye" class="absolute right-3 top-10 w-8 cursor-pointer" id="hide"></img>
                        </div>
                        <div class="mb-4">
                                ...
                                className="shadow appearance-none border rounded w-full py-2 px-3 mb-2 text-gray-700 leading-10 focus:outline-none focus:shadow-outline" 
                                required/>
                                {errors.address && <span className='text-red-900'> {errors.address}</span>}
                        </div>
                        {/* <!-- Checkbox Input--> */}
                        <div class="mb-6"> 
                            <label for="TAC" class="flex items-center text-gray-500 text-md font-bold tracking-wider">
                            ...
                            <Link to='/login' className="text-blue-500 cursor-pointer font-semibold">Login here</Link>
                        </p>
                        ...
                        <a href="https://www.google.com/"><button class="flex items-center justify-center p-2 mt-10 w-full leading-10 border-2 border-gray-300 rounded-lg hover:bg-gray-200 font-semibold focus:outline-none focus:shadow-outline">
                            <img src={google} alt="Google Icon" class="w-16 px-5"/>Register with Google</button></a>
