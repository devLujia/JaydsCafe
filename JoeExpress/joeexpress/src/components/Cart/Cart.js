  ...
  <div class="bg-white">
    <nav class="sticky top-0 bg-white z-20">
        <div class="font-extrabold text-xl flex items-center py-1">
            <a href="/public/Html/menuPage.html" class="flex items-center w-96 h-10 hover:scale-110 hover:cursor-pointer hover:brightness-110 transition duration-200 hover:text-yellow-950"> <img src={arrowLeft} alt="Arrow Back" class=" w-14 h-14 mx-4"/>Back to Menu</a>
        </div>
    </nav>
        ...
        <div class=" px-20"> {/* <!-- Left side cards--> */}
            <div class="mt-5 w-full p-4 text-left bg-white border border-gray-200 rounded-lg shadow-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col justify-center ml-6">
                        <h5 class="text-3xl font-bold text-gray-900 dark:text-white">Taro Milk Tea</h5> {/*<!-- Title ng product-->*/}
                        <p class="text-base text-gray-500 sm:text-lg dark:text-gray-400 font-semibold">₱41.95</p> {/*<!-- price ng product-->*/}
                        <p class="text-base text-gray-500 sm:text-lg dark:text-gray-400 font-semibold">Size: <span class="font-normal">Large</span></p> {/*<!-- Size ng product-->*/}
                        <p class="text-base text-gray-500 sm:text-sm mb-2 dark:text-gray-400 font-normal">Addons: <span>Large</span></p> {/*<!-- addons ng product-->*/}
                    </div>
                </div>
                <div class="items-center justify-end space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                    ...
                    <div>
                        <button class="py-3 me-3 px-3 inline-block bg-white border-2 border-textgreenColor rounded-full dark:bg-neutral-900 dark:border-neutral-700" >
                            <img src={del} alt=""/>
                        </button>
                        <button class="py-3 px-3 inline-block bg-white border-2 border-textgreenColor rounded-full dark:bg-neutral-900 dark:border-neutral-700" >
                            <img src={edit} alt=""/>
                        </button>
                    </div>
                </div>
            ...
            <div class="mt-5 w-full p-4 text-left bg-white border border-gray-200 rounded-lg shadow-lg sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col justify-center ml-6">
                        <h5 class="text-3xl font-bold text-gray-900 dark:text-white">Cookies N' Cream Milk Tea</h5> {/*<!-- Title ng product-->*/}
                        <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">M</p> {/*<!-- Size ng product-->*/}
                    </div>
                </div>
                <div class="items-center justify-end space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                    {/* <!-- numper input --> */}
                    <div class="py-2 px-3 inline-block bg-white border-2 border-textgreenColor rounded-full dark:bg-neutral-900 dark:border-neutral-700" data-hs-input-number="">
                        <div class="flex items-center gap-x-1.5">
                          ...
                          <input id="input-number1" class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:text-white" type="number" aria-roledescription="Number field" value="0" data-hs-input-number-input=""/>
                          <button type="button" id="increment-btn1" class="size-7 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" tabindex="-1" aria-label="Increase" data-hs-input-number-increment="">
                            <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                              <path d="M5 12h14"></path>
                              <path d="M12 5v14"></path>
                            </svg>
         ...
         {/* <!-- Right side Infos--> */}
        <div class="bg-background flex justify-center px-20 py-10">
            <div class="min-w-full sticky top-0 bg-white outline outline-gray-500 rounded-lg shadow-lg px-5 py-7">
                <h1 class="text-2xl font-extrabold mb-6 tracking-wider  text-center">Select your delivery method</h1>
                
                <form action="">
                    <ul class="grid w-full gap-5 md:grid-cols-2 px-14 text-center">
                        <li>
                            <input type="radio" id="delivery" name="hosting" value="delivery" class="hidden peer" required />
                            <label for="delivery" class="inline-block items-center justify-center py-5 w-full text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-textgreenColor peer-checked:border-textgreenColor peer-checked:text-textgreenColor hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
                                <img src={motor} alt="" class="mx-auto mb-2"/>
                                <div class="block">
                                    <div class="w-full text-xl font-semibold">Local Delivery</div>
                                </div>
                            </label>
                        </li>
                        <li>
                            <input type="radio" id="store" name="hosting" value="store" class="hidden peer"/>
                            <label for="store" class="inline-block items-center justify-center py-5 w-full text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-textgreenColor peer-checked:border-textgreenColor peer-checked:text-textgreenColor hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
                    ...
                    <label for="instruction" class="block mb-2 pl-1 text-lg font-medium text-gray-700">Instructions (Option)</label>
                ...
                <div class="flex items-center pt-5">
                    <h1 class="text-3xl font-extrabold tracking-wider">₱150.00</h1>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <button onclick="window.location.href='trackingPage.html'" data-modal-hide="popup-modal" type="button" class="text-white ms-3 bg-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-yellow-400 dark:focus:ring-yellow-800 font-medium rounded-full text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Yes, I'm sure
                    </button>
                </div>
            </div>
