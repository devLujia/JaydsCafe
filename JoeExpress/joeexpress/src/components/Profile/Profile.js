    ...
    try {
        if (newAddress !== profile.address && newAddress !== '') {
            ...
            if (res.data.success) {
             ...
             toast.warning("No changes made or invalid address.", {
                autoClose: 3000, 
                hideProgressBar: true, 
                closeOnClick: true, 
                pauseOnHover: true, 
      ...
      const response = await axios.post('http://localhost:8081/updatePersonalInfo', {
        ...
        userId: userId
          ...
          if (response?.data?.success) {
            toast.success("Update Successful", {
              autoClose: 3000, // Duration for toast visibility (ms)
        ...
        <div class="flex flex-col items-center overflow-x-hidden mb-6 ml-16 absolute bottom-0 gap-3 md:items-start md:flex-row"> {/* <!-- container ng profile pic --> */}
          ...
          <div class="w-full lg:px-20"> {/* <!-- main container of tabs--> */}
            ...
            <div id="default-tab-content"> {/* <!-- Content of every tabs --> */}
              {/* <!-- Order Tab--> */}
                {activeTab === 'order' && (
                  <div className="relative p-4 rounded-lg my-7 bg-gray-50 dark:bg-gray-800 min-h-[550px] mx-4 md:mx-8 lg:mx-16 overflow-x-auto lg:overflow-hidden">
                    ...
                    <table className="w-full text-xs md:text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-collapse border-spacing-0">
                      <thead className="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                        <tr className="text-center">
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">ID</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Name</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Address</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Contact Number</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Date / Time</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Price</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Status</th>
                          <th className="px-2 md:px-4 py-2 md:py-3 border-b dark:border-gray-600">Action</th>
                        </tr>
                      </thead>
                            ...
                            <React.Fragment key={order?.order_id}>
                              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td className="flex items-center px-2 md:px-4 py-2 md:py-4 space-x-2 justify-center gap-2">
                                  ...
                                  {order?.deliveryMethod === 'Delivery' && order?.status === 'on delivery' && (
                                    <button onClick={() => openChat(order?.order_id)} title="Chat with Rider">
                    ...
                    {/* Pagination Controls */}
                    <div className="flex justify-center items-center  space-x-2 bottom-2 absolute w-full">
                      <button
