        ...
        <section class=" mt-20">
            ...
            <div class="flex justify-evenly items-center mb-24">
                <div>
                    ...
                    Order Number: 
                    <span class="block text-center">#240881</span>
                    </p>
                </div>
                <div>
                    <p class="text-2xl text-center">
            ...
            <div class=""> 
                <ol class="flex items-center w-[90%] justify-center mx-auto">
                    ...
                    <li class="flex w-full items-center text-textgreenColor dark:text-textgreenColor after:content-[''] after:w-full after:h-1 after:border-b after:border-textgreenColor after:border-4 after:inline-block dark:after:border-blue-800">
