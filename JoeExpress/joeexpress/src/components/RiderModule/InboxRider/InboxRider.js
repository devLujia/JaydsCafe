            ...
            <div class="container mx-auto shadow-lg rounded-lg max-h-[500px] min-h-[500px]">
               ...
               <div class="flex flex-row justify-between bg-white dark:bg-gray-800  max-h-[500px] min-h-[500px]">
                  ...
                  <div class="flex flex-col w-2/5 border-r-2 overflow-y-auto">
                     ...
                     <div key={order.order_id} onClick={() => fetchMessages(order?.order_id || '')} class="flex flex-row py-3 px-5 justify-center items-center hover:bg-gray-200 overflow-auto cursor-pointer">
                        <div class="w-1/4">
                           <img
                           src={user}
