...
export default function DashboardRider() {
  return (
    <div className='bg-slate-100'>
        <nav class="sticky top-0 bg-slate-100 z-20 shadow-none flex justify-betwee">
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
                ...
                <ul class="space-y-2 font-medium">
                    <li> {/* <!-- Dashboard --> */}
                        ...
                        <svg class="w-5 h-5 transition duration-75 dark:text-gray-400 text-white dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <div class="p-4 ml-8">
                ...
                {/* Cards top container */}
                 <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-5'>
                    {/* Cards 1 */}
                    <div className='bg-white rounded-lg p-5 font-semibold shadow-lg'>
